<template>
    <div class="personal-wrap" v-loading="loading">
        ...
        <div class="personal-bt personal-marTp">
            ...
            <div v-if="debitVisible">
                <section v-if="debitHave" class="app-main flex-wrapper flex-direction-column">
                    <el-form :model="accountForm" :rules="rules" ref="accountForm" label-width="240px" class="details-cardForm">
                        ...
                        <el-form-item label="Swift Code/IBAN：" class="code-iban" prop="swift_code">
                            <el-input style="max-width:46%" v-model="accountForm.swift_code" placeholder="Swift Code" @keyup.enter.native="debitForm"></el-input>
                            <span>or</span>
                            <el-input style="max-width:46%;" v-model="accountForm.iban" placeholder="iban" @keyup.enter.native="debitForm"></el-input>
                        </el-form-item>
        ...
        <!-- 弹框 -->
        <el-dialog title="" class="layer-wrap" :visible.sync="dialogFormVisible" width="600px" style="border-radius:10px">
            <img class="layer-tp-bg" src="../../assets/public-img/layer-user-info.png" />
            <el-form :model="ruleForm" :rules="rulesEid" ref="ruleForm" label-width="180px" class="details-ruleForm">
                ...
                <el-form-item>
                    <el-button style="margin-left:-40px" @click="getPersonalData">Cancel</el-button>
                    <el-button class="submit-btn" type="primary" @click.native.prevent="handleregister">Conflrm</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
    </div>
...
export default {
    ...
    mounted () {
        const { username, email } = typeof(this.userInfo) == 'string' ? JSON.parse(this.userInfo) : this.userInfo
