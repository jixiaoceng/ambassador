        ...
        <el-container class="app-inner">
            ...
            <el-container>
                <el-container class="main-container">
                    <section class="app-main flex-direction-column">
                        <el-form :model="ruleForm" :rules="rules" label-position="top" ref="ruleForm" label-width="155px" class="details-ruleForm">
                            ...
                            <el-form-item label="WhatsApp：" >
                                ...
                                <el-input style="width:100px" v-model="ruleForm.country_calling_code" maxlength="3" placeholder="65"></el-input>
                                <el-input style="width:190px;" v-model="ruleForm.telephone_no" maxlength="16" placeholder="telephone number"></el-input>
                            </el-form-item>
